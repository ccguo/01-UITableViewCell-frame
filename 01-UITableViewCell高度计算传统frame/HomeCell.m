...
- (void)layoutSubviews
{
    ...
    CGSize labelSize = [self.title sizeWithFont:[UIFont systemFontOfSize:17] constrainedToSize:CGSizeMake(width-20, 500)];
...
{
    CGFloat height = 20;
    CGSize labelSize = [title sizeWithFont:[UIFont systemFontOfSize:17] constrainedToSize:CGSizeMake(300, 500)];
